...
public:
    ...
    static bool loadIntoRaw(std::vector<Vec3d> & xs, std::vector<Vec3st> & fs, std::vector<Vec2i> & ls, std::vector<Vec3d> & vels, std::vector<size_t> & solid_vertices, const std::string & filename, bool binary = true);

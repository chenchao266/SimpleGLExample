...
void SurfTrack::defrag_mesh( )
{
    ...
    if ( !any_deleted )
    {
        ...
        double end_time = tm.time_m();
        g_stats.add_to_double( "total_clear_deleted_vertices_time", end_time );
...
void SurfTrack::defrag_mesh_from_scratch_manual(std::vector<size_t> & vertices_to_be_mapped)
{
    ...
    double end_time = tm.time_m();
    g_stats.add_to_double("total_defrag_time", end_time );

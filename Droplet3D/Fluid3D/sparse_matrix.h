...
struct SparseMatrix
{
   ...
   explicit SparseMatrix(unsigned int m_)
   ...
   explicit SparseMatrix(unsigned int m_, unsigned int n_, unsigned int expected_nonzeros_per_row = 7)

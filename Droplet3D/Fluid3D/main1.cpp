...
int main1(int argc, char **argv)
{
   ...
   if(argc!=3){
      std::cerr << "The first parameter should be the folder to write the output liquid meshes into. (eg. c:\\output\\)"<<"advection_method" << std::endl;
      return 1;
   }
...
void export_particles(std::string path, int frame, const std::vector<FLIP_particle>& particles_in, float radius) {
   //Write the output

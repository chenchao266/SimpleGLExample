		...
		for (int j = 0; j <= size[1]; j++)
		{
			for (int k = 0; k <= size[2]; k++)
			{
				...
				if (i > 0)
				{
					...
					if (abs(me - other) > 1.5)
					{
                        std::cout << "Bad grid spot at " << i << " " << j << " " << k << " " << me << " " << other << std::endl;
					}
				}

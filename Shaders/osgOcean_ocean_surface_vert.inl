...
static const char osgOcean_ocean_surface_vert[] =
	...
	"    gl_Position = osg_ModelViewProjectionMatrix * inputVertex;\n"
	"\n"
	...
	"\n"
	"        inputVertex = vec4(osg_Vertex.x, \n"
	"                           osg_Vertex.y, \n"
	"                           mix(osg_Vertex.z, sin(osgOcean_FrameTime), height),\n"
	"                           osg_Vertex.w);\n"
	"\n"
	"        gl_Position = osg_ModelViewProjectionMatrix * inputVertex;\n"
	"    }\n"
	...
	"    // In object space\n"
	"    vVertex = inputVertex;\n"
	"    vLightDir = normalize( vec3( osg_ModelViewMatrixInverse * ( gl_LightSource[osgOcean_LightID].position ) ) );\n"
	"    vViewerDir = osg_ModelViewMatrixInverse[3].xyz - inputVertex.xyz;\n"
	"    vNormal = normalize(osg_Normal);\n"
	"\n"
	"    vec4 waveColorDiff = osgOcean_WaveTop - osgOcean_WaveBot;\n"
	"\n"
	"    gl_FrontColor = waveColorDiff *\n"
	"        clamp((osg_Vertex.z + osgOcean_Eye.z) * 0.1111111 + vNormal.z - 0.4666667, 0.0, 1.0) + osgOcean_WaveBot;\n"
	"\n"
	"    // -------------------------------------------------------------\n"
	"\n"
	...
	"\n"
	"    // world space\n"
	"    vWorldVertex = modelMatrix * osg_Vertex;\n"
	"    vWorldNormal = modelMatrix3x3 * osg_Normal;\n"
	"    vWorldViewDir = vWorldVertex.xyz - osgOcean_Eye.xyz;\n"
	"\n"
	"    // ------------- Texture Coords ---------------------------------\n"
	"\n"
	"    // Normal Map Coords\n"
	"    osg_TexCoord0.xy = ( osg_Vertex.xy * osgOcean_NoiseCoords0.z + osgOcean_NoiseCoords0.xy );\n"
	"    osg_TexCoord0.zw = ( osg_Vertex.xy * osgOcean_NoiseCoords1.z + osgOcean_NoiseCoords1.xy );\n"
	"    osg_TexCoord0.y = -osg_TexCoord0.y;\n"
	"    osg_TexCoord0.w = -osg_TexCoord0.w;\n"
	"\n"
	"    // Foam coords\n"
	"    osg_TexCoord1.st = osg_Vertex.xy * osgOcean_FoamScale;\n"
	"\n"
	"    // Fog coords\n"

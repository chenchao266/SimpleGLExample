...
static const char osgOcean_ocean_scene_vert[] =
	...
	"void main(void)\n"
	"{\n"
	"	osg_TexCoord0 = osg_MultiTexCoord0;\n"
	"	gl_Position = osg_ModelViewProjectionMatrix * osg_Vertex;\n"
	"	gl_FogFragCoord = gl_Position.z;\n"
	"	gl_ClipVertex = osg_ModelViewMatrix * osg_Vertex; // for reflections\n"
	"\n"
	"	vNormal = osg_NormalMatrix * osg_Normal;\n"
	"	vLightDir = gl_LightSource[osgOcean_LightID].position.xyz;\n"
	"	vEyeVec = -vec3(osg_ModelViewMatrix*osg_Vertex);\n"
	"\n"
	"	vec4 worldVertex = (osg_ViewMatrixInverse*osg_ModelViewMatrix) * osg_Vertex;\n"
	"\n"

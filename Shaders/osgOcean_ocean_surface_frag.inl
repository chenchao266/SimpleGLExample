...
static const char osgOcean_ocean_surface_frag[] =
	...
	"              0.5, 0.5, 0.5, 1.0 );\n"
	"\n"
	"    mat4 texgen_matrix = mr * osg_ProjectionMatrix * osg_ModelViewMatrix;\n"
	"\n"
	"    //float disp = 8.0;\n"
	"    float disp = 4.0;\n"
	"\n"
	...
	"    vec4 final_color;\n"
	"\n"
	"    vec3 noiseNormal = vec3( texture2D( osgOcean_NoiseMap, osg_TexCoord0.xy ) * 2.0 - 1.0 );\n"
	"    noiseNormal += vec3( texture2D( osgOcean_NoiseMap, osg_TexCoord0.zw ) * 2.0 - 1.0 );\n"
	"\n"
	"    worldObjectMatrix = osg_ViewMatrixInverse * osg_ModelViewMatrix;\n"
	"\n"
	"    if(gl_FrontFacing)\n"
	"    {\n"
	...
	"        vec4 refraction_color = vec4( osg_Color.rgb, 1.0 );\n"
	...
	"            {\n"
	"                vec4 foam_color = texture2D( osgOcean_FoamMap, osg_TexCoord1.st / 10.0);\n"
	"\n"
	"                float alpha;\n"
	"                if (osgOcean_EnableHeightmap)\n"
	"                {\n"

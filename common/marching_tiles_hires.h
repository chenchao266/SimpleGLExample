...
{
   LosTopos::Array1<Vec3st> tri;
   LosTopos::Array1<Vec3d> x;
   LosTopos::Array1<Vec3d> normal;
    Vec3d origin;
   double dx;
   const LosTopos::Array3d& phi;

   MarchingTilesHiRes(const Vec3d &origin_, double dx_, const LosTopos::Array3d& phi_) :
      tri(0), x(0), normal(0),
   ...
   private:
   LosTopos::HashTable<Vec6i,unsigned int> edge_cross; // stores vertices that have been created already at given edge crossings

...
//    return simplex_intersection2d( 2, x0.u, x1.u, x2.u, x3.u, &bary[0], &bary[1], &bary[2], &bary[3] );
//}
//
//
//bool segment_segment_intersection(const Vec2d& x0, size_t /*index0*/, 
...
//    return simplex_intersection2d( 2, x0.u, x1.u, x2.u, x3.u, &s0, &s1, &s2, &s3 );
//}
                              ...
                              double& relative_normal_displacement )
{
    ...
    if ( rayhex_result )
    {
        ...
        Vec3d dx2 = xnew2 - x2;
        Vec3d dx3 = xnew3 - x3;   
        relative_normal_displacement =  ( normal).dot(dx0 - bary1*dx1 - bary2*dx2 - bary3*dx3 );
    }
                               ...
                               double& relative_normal_displacement )
{
    ...
    if ( rayhex_result )
    {
        ...
        relative_normal_displacement =  ( normal).dot(bary0*dx0 + (1.0-bary0)*dx1 - bary2*dx2 - (1.0-bary2)*dx3 );
    }
...
{
    double bary[5];
    return simplex_intersection3d( 2, x0.u, x1.u, x2.u, x3.u, x4.u, &bary[0], &bary[1], &bary[2], &bary[3], &bary[4] ) != 0;
}
...
bool segment_triangle_intersection(const Vec3d& x0, size_t /*index0*/,
                                   ...
                                   bool /*verbose*/ )
{
    return simplex_intersection3d( 2, x0.u, x1.u, x2.u, x3.u, x4.u, &bary0, &bary1, &bary2, &bary3, &bary4 ) != 0;
}
...
{
    double bary[5];
    return simplex_intersection3d( 1, x0.u, x1.u, x2.u, x3.u, x4.u, &bary[0], &bary[1], &bary[2], &bary[3], &bary[4] ) != 0;
}

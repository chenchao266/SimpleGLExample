...
void check_edge_edge_proximity(const Vec3d &x0, const Vec3d &x1, const Vec3d &x2, const Vec3d &x3, double &distance)
{
    ...
    x32/=r11;
    Vec3d x31=x3-x1;
    double s2= x32.dot(x31)/r11;
    double s0=( x01.dot(x31)-r01*s2)/r00;
                                    ...
                                    double &distance)
{
    ...
    x23/=r11;
    Vec3d x03=x0-x3;
    double s2= x23.dot(x03)/r11;
    double s1=( x13.dot(x03)-r01*s2)/r00;
    double s3=1-s1-s2;

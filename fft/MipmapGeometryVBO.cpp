...
#include <stdlib.h>
    ...
    MipmapGeometryVBO::MipmapGeometryVBO( void )
        ...
        ,_worldSize      ( 0.f )
    {
        setDataVariance ( GL_DYNAMIC_DRAW );
        //setNormalBinding( Array::BIND_PER_VERTEX );
    ...
    MipmapGeometryVBO::MipmapGeometryVBO( const MipmapGeometryVBO& copy )
        :GeometryShape( copy )
    ...
    void MipmapGeometryVBO::computeBoundingBox(Vec3f& bbMin, Vec3f&bbMax) const
    {
 
        bbMin.x = _offset.x;
        bbMax.x = _offset.x+_worldSize;
        bbMin.y = _offset.y-_worldSize;
        bbMax.y = _offset.y;
        bbMin.z = -5.f;
        bbMax.z = 5.f;
    ...
    bool MipmapGeometryVBO::checkPrimitives( unsigned int level, unsigned int levelRight, unsigned int levelBelow )
    {
        ...
        {   
            //////std::cout << "MipmapGeometryVBO() - Mipmap level difference is greater than 1" << std::endl;
        }
#endif 
...
//#define NO_DEGENERATE_TRIANGLES
    void MipmapGeometryVBO::addMainBody( void )
    {
        ...
        {
            DrawElementsUInt* primitive = new DrawElementsUInt( DrawElements::TRIANGLE_STRIP, indices );
            int i = 0;
            unsigned row = r*inc;
            ...
            _mainBody[p++]= std::shared_ptr<DrawElementsUInt>(primitive);
        }
#else
        ...
        _mainBody.push_back(std::shared_ptr<DrawElementsUInt>(primitive) );
#endif
    }
    ...
    void MipmapGeometryVBO::addZeroTile( void )
    {
        ...
        if( _resRight == 1 && _resBelow == 1 )
        {
            DrawElementsUInt* primitive = new DrawElementsUInt( DrawElements::TRIANGLE_STRIP, 4 );
        ...
        else
        {
            if( _resRight == 1 )
            {
                DrawElementsUInt* primitive = new DrawElementsUInt( DrawElements::TRIANGLE_FAN, 5 );
            ...
            {
                DrawElementsUInt* primitive = new DrawElementsUInt( DrawElements::TRIANGLE_FAN, 0 );
                primitive->reserve(6);
    ...
    void MipmapGeometryVBO::addZeroCornerPiece(void)
    {
        ...
        _cornerPiece.push_back(std::shared_ptr<DrawElementsUInt>(primitive));
    }
    ...
    void MipmapGeometryVBO::addBottomBorder(void)
    {
        ...
        if(_level == _levelBelow )
        {
            ...
            DrawElementsUInt* primitive = new DrawElementsUInt( DrawElements::TRIANGLE_STRIP, indicies);
            ...
            _belowBorder.push_back(std::shared_ptr<DrawElementsUInt>(primitive));
        }
        ...
        {
            //////std::cout << "BELOW BORDER ERROR" << std::endl;
        }
    }
    ...
    void MipmapGeometryVBO::addRightBorder( void )
    {
        ...
        if(_level == _levelRight)
        {
            ...
            _rightBorder.push_back(std::shared_ptr<DrawElementsUInt>(primitive));
        }
        // lower res to the right

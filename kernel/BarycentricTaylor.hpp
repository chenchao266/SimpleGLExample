...
class BarycentricTaylor
    : public Expansion<Barycentric, BarycentricTaylor<P> >
{
 public:
  FMMTL_IMPORT_KERNEL_TRAITS(Barycentric);

  //! Point type
  typedef VecX<1,double> point_type;

  //! Multipole expansion type
  typedef GradedPolynomial<double,1,P> multipole_type;
  //! Local expansion type
  typedef GradedPolynomial<double,1,P> local_type;

  //! A multiindex ranging from 0 to P
  static constexpr multiindex<P> k{};
  ...
  void M2L(const multipole_type& M,
    ...
    GradedPolynomial<double,1,2*P> tmp(-translation, translation[0]);

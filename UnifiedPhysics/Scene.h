...
public:
    ...
    */
    void move(const b3Vector3& distance);
    /**
    * Gets the position of the object.
    */
    b3Vector3 getPosition();
    /**
...
protected:
	...
	*
	*/
	 ParticleObject LoadModel( const std::string& file_name, const float scale_x, const float scale_y, const float scale_z, const float spacing, UnifiedParticle& particle_template);
	/**
	...
	*/
	ParticleObject createBoxBoundaryFrozenParticles(UnifiedPhysics* physics, float spacing, UnifiedConstants* constants, float jitter, const b3Vector3 &offset);
	/**
	* Creates frozen particles at the boundary of the simulation in Multi Layers
	* spacing - the distance between the frozen particles.
	*/
	ParticleObject createBoxBoundaryFrozenParticlesMultiLayers(UnifiedPhysics* physics, float spacing, UnifiedConstants* constants, float jitter, const b3Vector3 &offset);
	/**
...
private:
	...
	*/
	...
	ParticleObject createChromeSphere(UnifiedPhysics* physics, UnifiedConstants* constants, float spacing, float jitter, const b3Vector3 &offset);
	ParticleObject createFluidObject(UnifiedPhysics* physics, UnifiedConstants* constants, float spacing, float jitter, const b3Vector3 &offset);
	...
	ParticleObject createRigidObject(const BoundBox& rigidBox, UnifiedPhysics* physics, UnifiedConstants* constants, float spacing, float jitter, const b3Vector3 &offset);
	ParticleObject createSurfaceParticlesObject(const std::string filename, const b3Vector3 scale, UnifiedPhysics* physics, UnifiedConstants* constants, 
		float spacing, float jitter, const b3Vector3 &offset, float density, float rb_density = 1000.0f);

	void CreateFullParticleObject(UnifiedConstants* fc, const b3Vector3 &offset, const float density, const int particleType, const char* model_file_name, 

...
//typedef vmml::Vector3<unsigned short int> Vec3us;
...
public:
  ...
  inline unsigned int CalcIndex(const Vec3us coordinate)
	{ return 0 | z_table_[coordinate[0]][0] | z_table_[coordinate[1]][1] | z_table_[coordinate[2]][2]; }
  inline unsigned int CalcIndex(const b3Vector3 coordinate)
  {
      return CalcIndex(Vec3us(coordinate.x, coordinate.y, coordinate.z));
  }
  ...
  void BoxQuery(const b3Vector3 min, const b3Vector3 max, ZRanges &ranges);

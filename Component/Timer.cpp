...
Timer* Timer::instance()
{
    ...
    Timer::Timer()
    {
        ...
        {
            _secsPerTick = 1.0;
            //NOTICE<<"Error: Timer::Timer() unable to use QueryPerformanceFrequency, "<<std::endl;
            //NOTICE<<"timing code will be wrong, Windows error code: "<<GetLastError()<<std::endl;
        }
    ...
    Timer_t Timer::tick() const
    {
        ...
        {
            //NOTICE<<"Error: Timer::Timer() unable to use QueryPerformanceCounter, "<<std::endl;
            //NOTICE<<"timing code will be wrong, Windows error code: "<<GetLastError()<<std::endl;
            return 0;
        }
    }
    ...
    Timer::Timer( void )
    {
        ...
        Timer_t Timer::tick() const
        {
            ...
            return ((Timer_t)ts.tv_sec)*1000000+(Timer_t)ts.tv_nsec/1000;
        }
    #else
        #include <sys/time.h>

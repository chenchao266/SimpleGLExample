...
public:
	 ...
	 * @return
	 */
	static b3Scalar getERP(b3Scalar timeStep, b3Scalar kSpring,
						   b3Scalar kDamper)
	{
	 ...
	 * @return
	 */
	static b3Scalar getCFM(b3Scalar avoidSingularity, b3Scalar timeStep, b3Scalar kSpring,
						   b3Scalar kDamper)
	{
		return b3Scalar(avoidSingularity) / (timeStep * kSpring + kDamper);
	}
};

...
public:
		  ...
		  m_tinyVrGUI(0)
	{
...

		{
            ...
            const Colorf color0 (0.1, 0.1, 0.5, 1);
            const Colorf color1 (0.6, 0.6, 0.6, 1);
  ...
  CommonExampleInterface* DynamicTexturedCubeDemoCreateFunc(  CommonExampleOptions& options)
{

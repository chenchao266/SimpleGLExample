	...
	switch (message)
	{
		...
		case WM_MBUTTONUP:
		{
			...
			if (sData)
			{
				...
				if (sData && sData->m_mouseButtonCallback)
					(*sData->m_mouseButtonCallback)(MOUSE_MIDDLE, MOUSE_UP, xPos, yPos);
			}
			break;
		}
		case WM_MBUTTONDOWN:
		{
			...
			if (sData)
			{
				...
				sData->m_mouseYpos = yPos;
				if (sData && sData->m_mouseButtonCallback)
					(*sData->m_mouseButtonCallback)(MOUSE_MIDDLE, MOUSE_DOWN, xPos, yPos);
			}
			break;
		}
		...
		case WM_LBUTTONUP:
		{
			...
			if (sData)
			{
				...
				if (sData && sData->m_mouseButtonCallback)
					(*sData->m_mouseButtonCallback)(MOUSE_LEFT, MOUSE_UP, xPos, yPos);
			}
		...
		case WM_LBUTTONDOWN:
		{
			...
			if (sData)
			{
				...
				if (sData && sData->m_mouseButtonCallback)
					(*sData->m_mouseButtonCallback)(MOUSE_LEFT, MOUSE_DOWN, xPos, yPos);
			}
			break;
		}
		...
		case WM_RBUTTONUP:
		{
			...
			if (sData && sData->m_mouseButtonCallback)
				(*sData->m_mouseButtonCallback)(MOUSE_RIGHT, MOUSE_UP, sData->m_mouseXpos, sData->m_mouseYpos);
		...
		case WM_RBUTTONDOWN:
		{
			...
			if (sData && sData->m_mouseButtonCallback)
				(*sData->m_mouseButtonCallback)(MOUSE_RIGHT, MOUSE_DOWN, sData->m_mouseXpos, sData->m_mouseYpos);

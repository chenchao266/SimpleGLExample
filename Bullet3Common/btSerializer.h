...
B3_FORCE_INLINE int btStrLen(const char* str)
{
	if (!str)
		return (0);
	int len = 0;
...
struct btBulletSerializedArrays
{
	...
	b3AlignedObjectArray<struct btCollisionShapeData*> m_colShapeData;
	b3AlignedObjectArray<struct btDynamicsWorldDoubleData*> m_dynamicWorldInfoDataDouble;
	b3AlignedObjectArray<struct btDynamicsWorldFloatData*> m_dynamicWorldInfoDataFloat;
 
	b3AlignedObjectArray<struct btCollisionObjectDoubleData*> m_collisionObjectDataDouble;
	b3AlignedObjectArray<struct btCollisionObjectFloatData*> m_collisionObjectDataFloat;
...
protected:
	...
	b3HashMap<b3HashPtr, btPointerUid> m_uniquePointers;
...
public:
	b3HashMap<b3HashPtr, void*> m_skipPointers;
	...
	{
		b3Assert(m_uniqueIdGenerator >= 0);
		if (!oldPtr)
			return 0;
...
{
	b3HashMap<b3HashPtr, btChunk*> m_uid2ChunkPtr;
	b3HashMap<b3HashPtr, void*> m_orgPtr2UniqueDataPtr;
	b3HashMap<b3HashString, const void*> m_names2Ptr;

...
{
	b3AlignedObjectArray<b3Vector3> m_4componentVertices;
	b3AlignedObjectArray<b3Scalar> m_3componentVertices;

	b3AlignedObjectArray<unsigned int> m_32bitIndices;
	b3AlignedObjectArray<unsigned short int> m_16bitIndices;
	bool m_use32bitIndices;
	bool m_use4componentVertices;

public:
	b3Scalar m_weldingThreshold;
	...
	void addTriangle(const b3Vector3& vertex0, const b3Vector3& vertex1, const b3Vector3& vertex2, bool removeDuplicateVertices = false);
	...
	int findOrAddVertex(const b3Vector3& vertex, bool removeDuplicateVertices);

...
class BoundingBoxImpl
{
    public:
        ...
        vec_type _max;
        inline const vec_type& getMin() const { return _min; }
        inline const vec_type& getMax() const { return _max; }
        ...
        inline void init()
        {
            _min = vec_type(FLT_MAX,
                     FLT_MAX,
                     FLT_MAX);
            _max= vec_type(-FLT_MAX,
                     -FLT_MAX,
                     -FLT_MAX);
        }
        ...
        inline void setMin(const vec_type& pMin){ _min = pMin; }
        inline void setMax(const vec_type& pMax) { _max = pMax; }
...
#endif
    typedef  BoundingBoxImpl<b3Vector3>  BoundBox;

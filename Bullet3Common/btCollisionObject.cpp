...
btCollisionObject::btCollisionObject()
	: m_interpolationLinearVelocity(0.f, 0.f, 0.f),
	  ...
	  m_contactProcessingThreshold(B3_LARGE_FLOAT),
	  ...
	  m_deactivationTime(b3Scalar(0.)),
	  m_friction(b3Scalar(0.5)),
	  m_restitution(b3Scalar(0.)),
	  m_rollingFriction(0.0f),
	  m_spinningFriction(0.f),
	  m_contactDamping(.1),
	  m_contactStiffness(B3_LARGE_FLOAT),
	  m_internalType(CO_COLLISION_OBJECT),
	  m_userObjectPointer(0),
	  m_userIndex2(-1),
	  m_userIndex(-1),
	  m_userIndex3(-1),
	  m_hitFraction(b3Scalar(1.)),
	  m_ccdSweptSphereRadius(b3Scalar(0.)),
	  m_ccdMotionThreshold(b3Scalar(0.)),

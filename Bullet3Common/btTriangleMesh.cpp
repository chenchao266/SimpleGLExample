	  ...
	  m_weldingThreshold(0.0)
{
	...
	meshIndex.m_vertexStride = sizeof(b3Vector3);
	...
	if (m_use4componentVertices)
	{
		...
		m_indexedMeshes[0].m_vertexStride = sizeof(b3Vector3);
	}
	else
	{
		m_indexedMeshes[0].m_numVertices = m_3componentVertices.size() / 3;
		m_indexedMeshes[0].m_vertexBase = 0;
		m_indexedMeshes[0].m_vertexStride = 3 * sizeof(b3Scalar);
	}
}
...
int btTriangleMesh::findOrAddVertex(const b3Vector3& vertex, bool removeDuplicateVertices)
{
	...
	else
	{
		if (removeDuplicateVertices)
		{
			...
			{
				b3Vector3 vtx(m_3componentVertices[i], m_3componentVertices[i + 1], m_3componentVertices[i + 2]);
...
void btTriangleMesh::addTriangle(const b3Vector3& vertex0, const b3Vector3& vertex1, const b3Vector3& vertex2, bool removeDuplicateVertices)
{
	m_indexedMeshes[0].m_numTriangles++;

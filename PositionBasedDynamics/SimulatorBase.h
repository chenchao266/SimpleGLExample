...
namespace SPH
{
	...
	protected:
		...
		std::unique_ptr<Utilities::SceneLoaderSPH> m_sceneLoader;
	...
	public:
		...
		*/
		...
		void initDensityMap(std::vector<Vector3r> &x, std::vector<unsigned int> &faces, const Utilities::SceneLoaderSPH::BoundaryData *boundaryData, const bool md5, const bool isDynamic, BoundaryModel_Koschier2017 *boundaryModel);
		void initVolumeMap(std::vector<Vector3r> &x, std::vector<unsigned int> &faces, const Utilities::SceneLoaderSPH::BoundaryData *boundaryData, const bool md5, const bool isDynamic, BoundaryModel_Bender2019 *boundaryModel);
		...
		Utilities::SceneLoaderSPH *getSceneLoader() { return m_sceneLoader.get(); }

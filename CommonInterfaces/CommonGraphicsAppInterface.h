...
struct CommonGraphicsApp
{
	...
	{
		m_backgroundColor.r = 0.7;
		m_backgroundColor.g = 0.7;
		m_backgroundColor.b = 0.8;
	}
	...
	{
		if (red)
			*red = m_backgroundColor.r;
		if (green)
			*green = m_backgroundColor.g;
		if (blue)
			*blue = m_backgroundColor.b;
	}
	...
	virtual void drawText(const char* txt, int posX, int posY, float size, const Colorf& colorRGBA) = 0;
	virtual void drawText3D(const char* txt, float posX, float posY, float posZ, float size) = 0;
	virtual void drawText3D(const char* txt, float position[3], float orientation[4], const Colorf& color, float size, int optionFlag) = 0;
	virtual void drawTexturedRect(float x0, float y0, float x1, float y1, const Colorf& color, float u0, float v0, float u1, float v1, int useRGBA) = 0;
	...
	virtual void registerGrid(int xres, int yres, const Colorf& color0, const Colorf& color1) = 0;
